...
class Ps_Banner extends Module implements WidgetInterface
{
    ...
    public function uninstallPrestaShop16Module()
    {
        ...
        Configuration::updateValue('BANNER_IMG_PHONE',Configuration::getInt('BLOCKBANNER_IMG'));
    ...
    public function getConfigFieldsValues()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $fields['BANNER_IMG_PHONE'][$lang['id_lang']] = Tools::getValue('BANNER_IMG_PHONE_'.$lang['id_lang'], Configuration::get('BANNER_IMG_PHONE', $lang['id_lang']));
